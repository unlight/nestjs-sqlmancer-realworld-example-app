...
export type ArticleFindOneBuilder<TSelected extends Pick<ArticleFields, any> = ArticleFields> = FindOneBuilder<
  'sqlite',
  ArticleFields,
  ArticleIds,
  ArticleEnums,
...
export type ArticleFindManyBuilder<TSelected extends Pick<ArticleFields, any> = ArticleFields> = FindManyBuilder<
  'sqlite',
  ArticleFields,
  ArticleIds,
  ArticleEnums,
...
export type ArticleFindByIdBuilder<TSelected extends Pick<ArticleFields, any> = ArticleFields> = FindByIdBuilder<
  ArticleFields,
  ArticleIds,
  ArticleEnums,
  ArticleAssociations,
...
export type ArticlePaginateBuilder = PaginateBuilder<'sqlite', ArticleFields, ArticleIds, ArticleEnums, ArticleAssociations>
